...
public class KusumaNumberPreferenceController extends BasePreferenceController {

    private static final String TAG = "kusumaNumberDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_KUSUMA_NUMBER_VERSION_PROP = "ro.kusuma.extra.version.number";

    private static final String PLATLOGO_PACKAGE_NAME = "top.kusuma.egg";
    ...
    public KusumaNumberPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_KUSUMA_NUMBER_VERSION_PROP,
