...
public class KusumaVersionPreferenceController extends BasePreferenceController {

    private static final String TAG = "KusumaVersionPreferenceController";
    ...
    public KusumaVersionPreferenceController(Context context, String key) {
        super(context, key);
    }
